...
> Download `OmniClipRAG-MCP-v0.4.9-win64.zip` for manual `stdio` setup or `omniclip-rag-mcp-win-x64-v0.4.9.mcpb` for the official MCP Registry / MCPB path.
...
- `OmniClipRAG-MCP-v0.4.9-win64.zip` for manual file-based setup
- `omniclip-rag-mcp-win-x64-v0.4.9.mcpb` for the official MCP Registry and MCPB-aware clients
...
- If your client supports MCPB installation, prefer the Release asset: `omniclip-rag-mcp-win-x64-v0.4.9.mcpb`
...
- `Command`: the full path to `OmniClipRAG-MCP.exe` (e.g. `D:\Apps\OmniClip RAG\dist\OmniClipRAG-MCP-v0.4.9\OmniClipRAG-MCP.exe`)
