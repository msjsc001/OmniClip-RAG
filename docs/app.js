(() => {
  ...
  const translations = {
    en: {
      ...
      hero_lead: "Search Markdown, PDF, and office documents with hybrid lexical and semantic retrieval—without uploading your knowledge base.",
      download_windows: "Download Windows EXE",
      ...
      features_kicker: "BUILT FOR PRIVATE KNOWLEDGE",
      features_title: "A retrieval engine, not another chat shell.",
      features_intro: "OmniClip prepares precise, traceable context. You decide where that context goes next.",
      ...
      workflow_kicker: "THREE STEPS",
      workflow_title: "Point. Index. Retrieve.",
      workflow_intro: "The archive remains yours from setup to query.",
      ...
      interface_title: "Every stage stays visible.",
      interface_intro: "These privacy-safe product views are built from the current interface structure and contain no local paths or personal knowledge.",
      ...
      format_documents: "Office and document formats",
    ...
    zh: {
      ...
      hero_lead: "在本机混合检索 Markdown、PDF 与办公文档，无需上传你的知识库。",
      download_windows: "下载 Windows EXE",
      view_source: "查看源代码",
      ...
      features_kicker: "为私人知识而构建",
      features_title: "它是检索引擎，不是另一个聊天外壳。",
      features_intro: "OmniClip 负责准备准确、可追溯的上下文；这些上下文去哪里，由你决定。",
      ...
      workflow_kicker: "三个步骤",
      workflow_title: "选择、建立、检索。",
      workflow_intro: "从配置到查询，知识母库始终属于你。",
      ...
      interface_title: "每个阶段都清楚可见。",
      interface_intro: "以下展示按照当前软件结构制作，不包含本机路径、私人知识或个人信息。",
